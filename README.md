...
#### Running the dev setup
  ...
  Execute the following:
      ...
      git clone https://github.com/kanselarij-vlaanderen/app-publieksontsluiting.git

      # Move into the directory
      cd app-publieksontsluiting
  ...
  Once the migrations have ran, you can start developing your application by connecting the ember frontend application to this backend.  See <https://github.com/kanselarij-vlaanderen/frontend-publieksontsluiting> for more information on development with the ember application.
